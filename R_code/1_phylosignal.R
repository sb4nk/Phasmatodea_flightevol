...
### WINGS
wing.table.caper <- read.csv("ASR_males.wings-ocelli.txt")[ ,c(1,4)]
...
#### FLIGHT
flight.table.caper <- read.csv("ASR_males.wings-ocelli.txt")[ ,c(1,5)]
...
### OCELLI
ocelli.table.caper <- read.csv("ASR_males.wings-ocelli.txt")[ ,c(1,3)]
...
table <- read.csv("ASR_males.wings-ocelli.txt", row.names = 1)
